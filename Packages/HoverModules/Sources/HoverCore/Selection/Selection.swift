...
public struct Selection: Equatable, Sendable {
    ...
    public init(markedIDs: Set<String> = [], anchorID: String? = nil) {
    ...
    public var isEmpty: Bool { markedIDs.isEmpty }

    public func isMarked(_ id: String) -> Bool { markedIDs.contains(id) }
    ...
    public mutating func markAll(_ ids: [String]) {
        markedIDs = Set(ids)
    ...
    public mutating func markRange(to id: String, in orderedIDs: [String]) {
    ...
    public mutating func replace(_ oldID: String, with newID: String) {
    ...
    public mutating func unmarkDeleted(_ id: String) {
        markedIDs.remove(id)
