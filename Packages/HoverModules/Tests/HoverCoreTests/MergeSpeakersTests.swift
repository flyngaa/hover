...
@Suite struct MergeSpeakersTests {
    ...
    @Test func assignsSegmentsToOverlappingSpeaker() {
        ...
        #expect(
            SpeakerAttribution.merge(segments: segments, turns: turns)
                == "**Speaker 1:** hello\n\n**Speaker 2:** world"
        )
    }
    ...
    @Test func mergesConsecutiveSameSpeaker() {
        ...
        #expect(
            SpeakerAttribution.merge(segments: segments, turns: turns) == "**Speaker 1:** a b"
        )
    }
    ...
    @Test func unknownSpeakerWhenNoOverlap() {
        ...
        #expect(
            SpeakerAttribution.merge(segments: segments, turns: turns) == "**Unknown speaker:** x"
        )
    }
